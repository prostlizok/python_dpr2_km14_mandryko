...
def get_word_score(word, n):
	...
	The second component is the larger of: 6 21-12
            1, or
    ...
    for i in word:
        comp1 += SCRABBLE_LETTER_VALUES.get(i, 0)

    equation = 7 * len(word) - 3 * (n-len(word))
    if equation > 1:
        comp2 = equation
    else:
        comp2 = 1
...
def is_valid_word(word, hand, word_list):
    ...
    if "*" in word:
        word= str(word.replace("*", f"[{VOWELS}]")) + "$"
        r = re.compile(word)    
        words_list = list(filter(r.match, word_list))
    ...
    while status == True:
        ...
        while True:
            try:
                ...
                if answ == "no" or answ == "yes":
                    break
                else:
                    raise Exception("You must enter yes or no!")
        ...
        if answ == "yes":
            while True:
                ...
                if letter in hand.keys():
                    ...
                    print(f"There's no {letter} in hand!")
        else:
            pass
        ...
        while calculate_handlen(hand)>0:
            ...
            if inp == '!!':
                ...
                if is_valid_word(inp, hand, word_list) == True:
                    score += get_word_score(inp, HAND_SIZE)
                    print(f"{inp} earned {get_word_score(inp, HAND_SIZE)} points")
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    print("---------------------")
    print("Total score over hands:", score)
